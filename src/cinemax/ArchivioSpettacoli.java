...
public class ArchivioSpettacoli {
    ...
    /** Percorso del file CSV contenente i dati delle proiezioni. */
    private String percorsoFile;

    /** Array contenente gli spettacoli caricati in memoria. */
    private Spettacolo[] elenco;

    /** Numero effettivo di spettacoli presenti nell'elenco. */
    private int quantita;

    /**
     * Inizializza l'archivio allocando la struttura dati e caricando
     * le proiezioni gia' presenti sul file indicato.
     */
    ...
    /**
     * Esegue il parsing dei campi di una singola riga di testo CSV, istanziando
     * l'oggetto Pellicola e il relativo Spettacolo associato.
     */
    ...
    /**
     * Inserisce uno spettacolo nell'array in memoria, raddoppiandone la capienza
     * qualora l'array raggiunga il limite massimo.
     */
    ...
    /**
     * Restituisce una copia dell'array contenente esclusivamente gli spettacoli
     * validi (senza celle nulle residue).
     */
    ...
    /**
     * Aggiunge un nuovo spettacolo in memoria e aggiorna immediatamente il file CSV su disco.
     */
    ...
    /**
     * Rimuove uno spettacolo corrispondente a titolo e data/ora, compatta l'array
     * per eliminare buchi e sincronizza la modifica sul file.
     */
