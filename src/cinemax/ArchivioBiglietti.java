...
public class ArchivioBiglietti {
    ...
    /** Percorso del file CSV su disco. */
    private String percorsoFile;

    /** Array che mantiene i biglietti in memoria. */
    private Biglietto[] elenco;

    /** Numero effettivo di biglietti correntemente presenti nell'array. */
    private int quantita;
    
    /**
     * Inizializza l'archivio allocando la struttura dati e caricando
     * le prenotazioni gia' presenti sul file specificato.
     */
    ...
    /**
     * Legge il file CSV riga per riga, converte ogni riga in un oggetto
     * Biglietto e popola l'array in memoria. Se il file non esiste,
     * l'archivio parte vuoto.
     */
    ...
    /**
     * Inserisce un biglietto nell'array interno, raddoppiandone la
     * dimensione quando la capienza massima viene raggiunta.
     */
    ...
    /**
     * Restituisce una copia esatta dell'elenco dei biglietti, dimensionata
     * solo sul numero di elementi effettivi (senza celle nulle residue).
     */
    ...
    /**
     * Ricerca un biglietto tramite il suo codice identificativo,
    ...
    /**
     * Aggiunge un nuovo biglietto all'archivio in memoria e aggiorna
     * immediatamente il file su disco.
     */
    ...
    /**
     * Rimuove il biglietto identificato dal codice, compattando l'array
     * per non lasciare posizioni vuote, e sincronizza il file su disco.
     */
