...
public class CsvUtile {
    ...
    /**
     * Costruttore privato per impedire l'istanziazione di questa classe di utilita'.
     */
    private CsvUtile() {
    }

    /**
     * Suddivide una riga CSV nei suoi singoli campi, gestendo correttamente
     * il testo racchiuso tra doppi apici che potrebbe contenere virgole.
     */
    ...
    /**
     * Inserisce un valore nell'array dei campi all'indice specificato,
     * raddoppiandone la capienza se la memoria allocata e' esaurita.
     */
    ...
    /**
     * Compone una stringa formattata in CSV a partire dai campi passati come parametro,
     * effettuando l'escaping e racchiudendo tra virgolette i campi contenenti virgole o apici.
     */
